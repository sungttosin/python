...
b.append(10) # .은 "~의", append()는 "추가동작"을 의미
print(b)
...
c=a[::2] #2칸씩 띄엄띄엄
print(c)
c=a[5:1:-1] #5번 인덱스에서 2번까지 거꾸로 1칸식
print(c)
'''
'''
#문제
...
c=a[2][0:2]
#위 문제에서 0,1,2,3 중 2번을 선택해서 py만 슬라이스 해주기
print(c)
'''
...
#문제
'''
자연수 하나를 입력받아 2의 배수인지, 3의 배수인지,
6의 배수인지 판단하는 프로그램 작성해 봅시다.
ex)
입력:12
출력:6의 배수 입니다.
'''
